defmodule UnderworkWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(UnderworkWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(UnderworkWeb.Gettext, "errors", msg, opts)
    end
  end
